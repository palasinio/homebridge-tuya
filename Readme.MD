...
This fork includes Homebridge 2 compatibility fixes for cached accessories, malformed Tuya LAN discovery payloads, and automatic sanitizing of invalid HomeKit accessory names.
